                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="mt-12 pt-8 border-t border-neutral-900">
                            <a href="tel:+15551234567" className="inline-flex items-center justify-center md:justify-start gap-3 w-full md:w-auto px-10 py-5 text-lg font-bold text-black transition-all bg-amber-500 hover:bg-white rounded shadow-[0_0_30px_-5px_rgba(245,158,11,0.4)]">
